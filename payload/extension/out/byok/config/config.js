...
function normalizeConfig(raw) {
  ...
  if (historySummary && typeof historySummary === "object" && !Array.isArray(historySummary)) {
    ...
    const useHistorySummaryNew = get(historySummary, ["use_history_summary_new", "useHistorySummaryNew"]);
    if (typeof useHistorySummaryNew === "boolean") hs.useHistorySummaryNew = useHistorySummaryNew;
    const tOld = typeof get(historySummary, ["summary_node_request_message_template", "summaryNodeRequestMessageTemplate"]) === "string" ? get(historySummary, ["summary_node_request_message_template", "summaryNodeRequestMessageTemplate"]) : "";
    if (normalizeString(tOld)) hs.summaryNodeRequestMessageTemplate = tOld;
    const tNew = typeof get(historySummary, ["summary_node_request_message_template_new", "summaryNodeRequestMessageTemplateNew"]) === "string" ? get(historySummary, ["summary_node_request_message_template_new", "summaryNodeRequestMessageTemplateNew"]) : "";
    if (normalizeString(tNew)) hs.summaryNodeRequestMessageTemplateNew = tNew;
